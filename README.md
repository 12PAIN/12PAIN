...
Aslo, there is description and the config on how to run it inside k8s cluster with KServe. 

This repository is used in production service at my current work.
<!--
